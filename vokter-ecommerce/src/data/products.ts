...
export const products: Product[] = [
  // 🎧 Manos Libres (1-4)
  {
    ...
    brand: "Vokter", price: 7600, stock: 50, images: ["/images/music_colores.jpeg"], featured: false, rating: 4.0, reviewsCount: 12,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Manos Libres",
    brand: "Vokter", price: 7600, stock: 45, images: ["/images/w_01.jpeg"], featured: false, rating: 3.8, reviewsCount: 8,
    specifications: [{ label: "Conector", value: "3.5mm" }, { label: "Tipo", value: "Manos Libres" }], createdAt: "2025-01-01",
  },
  {
    id: "3", name: "Z1", slug: "z1", description: "Auriculares manos libres 3.5mm con control de llamadas.",
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Manos Libres",
    brand: "Vokter", price: 7000, stock: 60, images: ["/images/z1.jpeg"], featured: false, rating: 3.9, reviewsCount: 15,
    specifications: [{ label: "Conector", value: "3.5mm" }, { label: "Tipo", value: "Manos Libres" }], createdAt: "2025-01-01",
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Manos Libres",
    brand: "Samsung", price: 7200, stock: 30, images: ["/images/samsung_akg.jpeg"], featured: false, rating: 4.3, reviewsCount: 22,
  ...
  // 🎧 Balacas Bluetooth (5-7)
  {
    ...
    brand: "Vokter", price: 70000, stock: 25, images: ["/images/balaca_pro_air.jpeg"], featured: true, rating: 4.5, reviewsCount: 34,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Balacas Bluetooth",
    brand: "Vokter", price: 70000, stock: 20, images: ["/images/balaca_air_max_imantada.jpeg"], featured: true, rating: 4.4, reviewsCount: 28,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Balacas Bluetooth",
    brand: "Vokter", price: 126000, stock: 15, images: ["/images/balaca_gamer.jpeg"], featured: false, rating: 4.6, reviewsCount: 19,
  ...
  // 🎧 Diademas (8-12)
  {
    ...
    brand: "Sony", price: 29000, stock: 18, images: ["/images/sony_mdr_xb450.jpeg"], featured: false, rating: 4.2, reviewsCount: 31,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Diademas",
    brand: "Vokter", price: 64000, stock: 12, images: ["/images/n65bt.jpeg"], featured: false, rating: 4.1, reviewsCount: 16,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Diademas",
    brand: "Sony", price: 50000, stock: 10, images: ["/images/sony_bt_450.jpeg"], featured: false, rating: 4.3, reviewsCount: 25,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Diademas",
    brand: "Vokter", price: 104000, stock: 8, images: ["/images/p9_tipo_apple.jpeg"], featured: true, rating: 4.7, reviewsCount: 42,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Diademas",
    brand: "Apple", price: 104000, stock: 5, images: ["/images/airpods_max.jpeg"], featured: true, rating: 4.8, reviewsCount: 56,
  ...
  // 📿 Cuelleras (13-15)
  {
    ...
    brand: "Vokter", price: 36000, stock: 22, images: ["/images/zon_35.jpeg"], featured: false, rating: 4.0, reviewsCount: 11,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Cuelleras",
    brand: "Vokter", price: 76000, stock: 10, images: ["/images/f_20.jpeg"], featured: true, rating: 4.4, reviewsCount: 18,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Cuelleras",
    brand: "Vokter", price: 80000, stock: 8, images: ["/images/f805.jpeg"], featured: false, rating: 4.5, reviewsCount: 14,
    specifications: [{ label: "Tipo", value: "Conducción Ósea" }, { label: "Conexión", value: "Bluetooth" }], createdAt: "2025-01-01",
  },
  ...
  // 🔊 Parlantes (16-20)
  {
    ...
    brand: "Vokter", price: 76000, stock: 15, images: ["/images/s410.jpeg"], featured: false, rating: 4.1, reviewsCount: 20,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Parlantes",
    brand: "Vokter", price: 150000, stock: 10, images: ["/images/s430.jpeg"], featured: false, rating: 4.3, reviewsCount: 17,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Parlantes",
    brand: "Vokter", price: 170000, stock: 7, images: ["/images/fl828.jpeg"], featured: true, rating: 4.6, reviewsCount: 23,
  ...
  },
  {
    ...
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Parlantes",
    brand: "Vokter", price: 26000, stock: 25, images: ["/images/s640.jpeg"], featured: false, rating: 3.9, reviewsCount: 9,
    specifications: [{ label: "Tipo", value: "Parlante Bluetooth portátil" }, { label: "Conexión", value: "Bluetooth" }], createdAt: "2025-01-01",
  },
  {
    id: "20", name: "S520", slug: "s520", description: "Parlante Bluetooth 12\" con sonido potente y graves profundos.",
    category: { id: "audio", name: "Audio", slug: "audio", description: "", image: "" }, subcategory: "Parlantes",
    brand: "Vokter", price: 170000, stock: 6, images: ["/images/s520.jpeg"], featured: true, rating: 4.7, reviewsCount: 29,
  ...
  // 🔌 Cables (21-24)
  {
    ...
    brand: "Vokter", price: 17000, stock: 40, images: ["/images/px_214.jpeg"], featured: false, rating: 4.2, reviewsCount: 33,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cables",
    brand: "Vokter", price: 27600, stock: 35, images: ["/images/px_400.jpeg"], featured: false, rating: 4.4, reviewsCount: 27,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cables",
    brand: "Xiaomi", price: 7000, stock: 50, images: ["/images/xiaomi_tipo_c.jpeg"], featured: false, rating: 4.0, reviewsCount: 40,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cables",
    brand: "Vokter", price: 9000, stock: 30, images: ["/images/cable_rca_2x1.jpeg"], featured: false, rating: 3.8, reviewsCount: 6,
  ...
  // 🔌 Cargadores de Carro (25-27)
  {
    ...
    brand: "Vokter", price: 15000, stock: 30, images: ["/images/c209.jpeg"], featured: false, rating: 4.1, reviewsCount: 14,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Carro",
    brand: "Ainocel", price: 19000, stock: 25, images: ["/images/klj_15_ainocel.jpeg"], featured: false, rating: 4.2, reviewsCount: 11,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Carro",
    brand: "Ainocel", price: 26000, stock: 20, images: ["/images/r_01_ainocel.jpeg"], featured: true, rating: 4.5, reviewsCount: 18,
  ...
  // 🔌 Cargadores de Pared (28-35)
  {
    ...
    brand: "Technomaster", price: 18000, stock: 35, images: ["/images/cg_06_technomaster.jpeg"], featured: false, rating: 4.0, reviewsCount: 16,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Vokter", price: 11600, stock: 40, images: ["/images/cg_16.jpeg"], featured: false, rating: 3.9, reviewsCount: 20,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Xiaomi", price: 32000, stock: 20, images: ["/images/mi_25w_pd_adapter.jpeg"], featured: false, rating: 4.4, reviewsCount: 28,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Xiaomi", price: 40000, stock: 18, images: ["/images/mi_67w_pd_adapter.jpeg"], featured: true, rating: 4.7, reviewsCount: 35,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Xiaomi", price: 44000, stock: 15, images: ["/images/xiaomi_67w_kit.jpeg"], featured: true, rating: 4.8, reviewsCount: 42,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Vokter", price: 14000, stock: 35, images: ["/images/cg_09_20w.jpeg"], featured: false, rating: 4.0, reviewsCount: 13,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Apple", price: 18000, stock: 25, images: ["/images/cabeza_iphone_25w.jpeg"], featured: false, rating: 4.3, reviewsCount: 21,
  ...
  },
  {
    ...
    category: { id: "cables-chargers", name: "Cables y Cargadores", slug: "cables-cargadores", description: "", image: "" }, subcategory: "Cargadores de Pared",
    brand: "Apple", price: 30000, stock: 20, images: ["/images/cargador_25w_tipo_c.jpeg"], featured: false, rating: 4.4, reviewsCount: 19,
  ...
  // 📱 Holders (36-40)
  {
    ...
    brand: "Vokter", price: 20000, stock: 30, images: ["/images/rn04_quick_snap.jpeg"], featured: false, rating: 4.1, reviewsCount: 15,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Holders",
    brand: "D&D", price: 19000, stock: 28, images: ["/images/h_022_dd.jpeg"], featured: false, rating: 4.0, reviewsCount: 12,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Holders",
    brand: "Vokter", price: 26000, stock: 15, images: ["/images/soporte_moto_manubrio.jpeg"], featured: false, rating: 4.3, reviewsCount: 9,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Holders",
    brand: "Vokter", price: 26000, stock: 12, images: ["/images/xl_m3_soporte_moto_espejo.jpeg"], featured: false, rating: 4.2, reviewsCount: 7,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Holders",
    brand: "Vokter", price: 30000, stock: 10, images: ["/images/h_73_soporte_moto_360.jpeg"], featured: false, rating: 4.4, reviewsCount: 11,
  ...
  // 🎙️ Micrófono (41)
  {
    ...
    brand: "Vokter", price: 50000, stock: 12, images: ["/images/k9_wireless_microphone.jpeg"], featured: false, rating: 4.1, reviewsCount: 8,
  ...
  // 🔋 Power Banks (42-45)
  {
    ...
    brand: "Vokter", price: 26000, stock: 30, images: ["/images/a_150_keychain_powerbank.jpeg"], featured: false, rating: 4.0, reviewsCount: 22,
  ...
  },
  {
    ...
    category: { id: "power-banks", name: "Power Banks", slug: "power-banks", description: "", image: "" }, subcategory: "Power Banks",
    brand: "Apple", price: 90000, stock: 10, images: ["/images/iphone_battery_magsafe.jpeg"], featured: true, rating: 4.6, reviewsCount: 31,
  ...
  },
  {
    ...
    category: { id: "power-banks", name: "Power Banks", slug: "power-banks", description: "", image: "" }, subcategory: "Power Banks",
    brand: "Ametech", price: 90000, stock: 15, images: ["/images/ametech_powerbank_10000.jpeg"], featured: false, rating: 4.3, reviewsCount: 25,
  ...
  },
  {
    ...
    category: { id: "power-banks", name: "Power Banks", slug: "power-banks", description: "", image: "" }, subcategory: "Power Banks",
    brand: "WiWU", price: 110000, stock: 8, images: ["/images/wiwu_powerbank_20000.jpeg"], featured: true, rating: 4.5, reviewsCount: 19,
  ...
  // 🖱️ Accesorios PC (46-50)
  {
    ...
    brand: "Vokter", price: 24000, stock: 25, images: ["/images/mouse_inalambrico_1600dpi.jpeg"], featured: false, rating: 4.0, reviewsCount: 16,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Accesorios PC",
    brand: "Vokter", price: 11000, stock: 35, images: ["/images/sj_100_mouse_alambrico.jpeg"], featured: false, rating: 3.8, reviewsCount: 10,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Accesorios PC",
    brand: "Vokter", price: 90000, stock: 10, images: ["/images/combo_gamer_t25.jpeg"], featured: true, rating: 4.4, reviewsCount: 24,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Accesorios PC",
    brand: "Weibo", price: 26000, stock: 20, images: ["/images/fc_530_weibo_teclado.jpeg"], featured: false, rating: 4.1, reviewsCount: 13,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Accesorios PC",
    brand: "Logitech", price: 110000, stock: 8, images: ["/images/logitech_mk220.jpeg"], featured: true, rating: 4.6, reviewsCount: 37,
  ...
  // 🎮 Consolas (51-54)
  {
    ...
    brand: "Vokter", price: 150000, stock: 5, images: ["/images/consola_blanca_verde_retro.jpeg"], featured: false, rating: 4.2, reviewsCount: 14,
  ...
  },
  {
    ...
    brand: "Vokter", price: 370000, stock: 3, images: ["/images/proyector_con_juegos.jpeg"], featured: true, rating: 4.7, reviewsCount: 21,
  ...
  },
  {
    ...
    brand: "Vokter", price: 110000, stock: 10, images: ["/images/android_tv_stick.jpeg"], featured: false, rating: 4.1, reviewsCount: 18,
  ...
  },
  {
    ...
    category: { id: "consoles", name: "Consolas y Entretenimiento", slug: "consolas-entretenimiento", description: "", image: "" }, subcategory: "TV Sticks",
    brand: "ONN", price: 160000, stock: 7, images: ["/images/onn_google_tv_stick.jpeg"], featured: true, rating: 4.5, reviewsCount: 25,
  ...
  // 📱 Estuches / Fundas (55-60)
  {
    ...
    brand: "Vokter", price: 6000, stock: 50, images: ["/images/space_collection.jpeg"], featured: false, rating: 4.0, reviewsCount: 30,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Fundas",
    brand: "Vokter", price: 9000, stock: 40, images: ["/images/silicon_iphone.jpeg"], featured: false, rating: 4.1, reviewsCount: 22,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Fundas",
    brand: "Vokter", price: 10000, stock: 45, images: ["/images/silicon_android.jpeg"], featured: false, rating: 3.9, reviewsCount: 18,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Fundas",
    brand: "Vokter", price: 24000, stock: 20, images: ["/images/samsung_lujo.jpeg"], featured: false, rating: 4.2, reviewsCount: 14,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Fundas",
    brand: "Vokter", price: 14000, stock: 30, images: ["/images/protector_air_pods.jpeg"], featured: false, rating: 4.3, reviewsCount: 16,
  ...
  },
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Fundas",
    brand: "Vokter", price: 14000, stock: 30, images: ["/images/protector_cargador.jpeg"], featured: false, rating: 3.9, reviewsCount: 9,
  ...
  // 🖥️ Accesorios PC/TV (61-63)
  {
    ...
    category: { id: "accessories", name: "Accesorios", slug: "accesorios", description: "", image: "" }, subcategory: "Accesorios PC",
    brand: "Vokter", price: 39000, stock: 15, images: ["/images/multipuerto_usb_30.jpeg"], featured: false, rating: 4.1, reviewsCount: 11,
  ...
  },
  {
    ...
    brand: "Vokter", price: 30000, stock: 12, images: ["/images/antena_tdt_5m.jpeg"], featured: false, rating: 3.8, reviewsCount: 7,
  ...
  },
  {
    ...
    category: { id: "consoles", name: "Consolas y Entretenimiento", slug: "consolas-entretenimiento", description: "", image: "" }, subcategory: "Accesorios TV",
    brand: "Vokter", price: 96000, stock: 8, images: ["/images/codificador_tdt_hdtv.jpeg"], featured: false, rating: 4.0, reviewsCount: 6,
  ...
  // 🇨🇴 Camisa Selección Colombia (100)
  {
    id: "100", name: "Camisa Selección Colombia", slug: "camisa-seleccion-colombia", description: "Camisa oficial de la Selección Colombia. Cómoda, fresca y perfecta para cualquier ocasión.",
    category: { id: "apparel", name: "Apparel", slug: "apparel", description: "", image: "" }, subcategory: "Hombre",
    brand: "", price: 120000, stock: 10, images: ["/images/camisa_colombia.jpeg"], featured: true, rating: 4.5, reviewsCount: 0,
    variants: [
      { id: "100-v1", productId: "100", size: "S", sku: "CAM-COL-S", stock: 4 },
      { id: "100-v2", productId: "100", size: "M", sku: "CAM-COL-M", stock: 4 },
      { id: "100-v3", productId: "100", size: "L", sku: "CAM-COL-L", stock: 4 },
      { id: "100-v4", productId: "100", size: "XL", sku: "CAM-COL-XL", stock: 4 },
    ],
    specifications: [{ label: "Selección", value: "Colombia" }, { label: "Tallas", value: "S/M/L/XL" }], createdAt: "2025-06-01",
  },

  // 🛏️ Sábanas Star Home (86-99)
  {
    id: "86", name: "Star Home Sábana 100% Algodón", slug: "star-home-sabana-algodon", description: "Juego de sábanas Star Home 100% algodón de 320 hilos. Tela fina y suave al tacto. Estampado azul marino + cuadros terracota.",
  ...
  {
    id: "87", name: "Star Home Sábana Puntos Azul", slug: "star-home-sabana-puntos-azul", description: "Juego de sábanas Star Home con estampado de puntos azul claro sobre fondo blanco. Confección premium de 320 hilos para un descanso de lujo.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "88", name: "Star Home Sábana Ondas Grises", slug: "star-home-sabana-ondas-grises", description: "Juego de sábanas Star Home con estampado de ondas grises/beige. Algodón de alta densidad 320 hilos, suaves y transpirables.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "89", name: "Star Home Sábana Dorado Óvalos", slug: "star-home-sabana-dorado-ovalos", description: "Juego de sábanas Star Home con estampado dorado con óvalos negros. Tela fina 320 hilos que brinda frescura y suavidad.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "90", name: "Star Home Sábana Estrellas", slug: "star-home-sabana-estrellas", description: "Juego de sábanas Star Home con estampado de estrellas azul marino/amarillo. 320 hilos de algodón puro para una sensación de lujo.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "91", name: "Star Home Sábana Círculos Grises", slug: "star-home-sabana-circulos-grises", description: "Juego de sábanas Star Home con estampado de círculos grises/azul sobre fondo beige. Acabado premium de 320 hilos, ultra suaves.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "92", name: "Star Home Sábana Geométrico Multicolor", slug: "star-home-sabana-geometrico-multicolor", description: "Juego de sábanas Star Home con estampado geométrico multicolor estilo pop art. Tela de 320 hilos, fina y elegante.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "93", name: "Star Home Sábana Líneas Camel", slug: "star-home-sabana-lineas-camel", description: "Juego de sábanas Star Home con estampado de líneas camel/azul marino. Algodón 320 hilos de alta calidad, frescas y cómodas.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "94", name: "Star Home Sábana Hojas Verdes", slug: "star-home-sabana-hojas-verdes", description: "Juego de sábanas Star Home con estampado de hojas verdes y círculos sobre fondo blanco. 320 hilos de suavidad excepcional.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "95", name: "Star Home Sábana Geométrico Azul/Rosa", slug: "star-home-sabana-geometrico-azul-rosa", description: "Juego de sábanas Star Home con estampado geométrico azul/rosa/verde. Tela premium 320 hilos para un descanso superior.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "96", name: "Star Home Sábana Floral Lila", slug: "star-home-sabana-floral-lila", description: "Juego de sábanas Star Home con estampado floral lila/morado sobre fondo blanco. Algodón fino de 320 hilos, delicadas y resistentes.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "97", name: "Star Home Sábana Círculos Grises Líneas", slug: "star-home-sabana-circulos-grises-lineas", description: "Juego de sábanas Star Home con estampado de círculos grises y líneas blancas. Confección de 320 hilos, tela suave y transpirable.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "98", name: "Star Home Sábana Ondas Beige/Gris", slug: "star-home-sabana-ondas-beige-gris", description: "Juego de sábanas Star Home con estampado de ondas beige/gris. 320 hilos de algodón premium, finas y acogedoras.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
  ...
  {
    id: "99", name: "Star Home Sábana Colección Completa", slug: "star-home-sabana-coleccion", description: "Juego de sábanas Star Home 100% algodón con diseño exclusivo. Tela de 320 hilos de alta densidad, suaves y duraderas.",
    category: { id: "bedding", name: "Hogar", slug: "hogar", description: "", image: "" }, subcategory: "Sábanas",
